...
// Angular:
const module = angular.module('myApp.view1', ['ngRoute', 'ngMaterial', 'ngMessages', 'ngVue'])
...
const VueComponent = Vue.component('vue-rangedate-picker', {
  template: `
...
module.value('vueRangedatePicker', VueComponent);